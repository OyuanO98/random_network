...
filename = "./compare/network" + sys.argv[1] + "mod1.txt"#**********
...
for i in range(10):
    net.add_event(200, Type_Mem, 'N' + str(i), 1, 0.25)#***********
    net.add_event(300, Type_Mem, 'N' + str(i), 0, 0)
net.add_event(1000, Type_End)

net.add_output('./compare/FiringRateALL' + sys.argv[2] + '.dat', 'FiringRate', 'AllPopulation', 100, 10)
